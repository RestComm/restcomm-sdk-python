...
class RestcommPhone(object):
    ...
    def NumberAvailability(self):
        ...
        Url=self.Uri+self.Sid+'/AvailablePhoneNumbers/US/Local'
        AreaCode = input("Enter the area code to check availability")
...
def main():
    ...
    details=RestcommPhone(AccountSid,Token,Ur)
    details.NumberAvailability()
