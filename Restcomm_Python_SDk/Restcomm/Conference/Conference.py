...
# Returns the representation of a Conference resource, including the properties above.
    def GetConference(self):
        ...
        try:
            ...
            Url = self.BaseUrl+'/Accounts/'+self.Sid+'/Conference/'+self.ConfSid+'.json'
...
# <Participants> represent set/list of in-progress calls in a running conference room.
    def InProgressCall(self):

        try:

            Url = self.BaseUrl+'/Accounts/'+self.Sid+'/Conferences/'+self.ConfSid+'/Participants'
